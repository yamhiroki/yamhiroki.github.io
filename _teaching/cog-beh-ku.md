...
# 講義
## 補足 R と 心理統計に関する資料
- R言語がほんのさわりだけになってしまいましたので、第7回で紹介した本に加えて、心理統計も含めて自学自習に適したサイトを紹介しておきます。Stanfordの心理学関連の授業で使われているものです。
 ...
 - [Statistical Methods for Behavioral and Social Sciences](http://web.stanford.edu/class/psych252/index.html)  
